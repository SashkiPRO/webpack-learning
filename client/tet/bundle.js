...
class Server {
    ...
    printSeparateElement(value, type) {
        ...
        if (type === 'department') row.appendChild(this.printEmployeeListButton(value));
    ...
    deleteEntity(url, id) {
        fetch(url + '/' + id, { method: 'DELETE' }).then(res => console.log('success')).catch(err => cosole.error(err));
    }
    ...
    printEmployeeForm(value) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__validation__["a" /* default */].validationEmployeeFunction();
    }
    ...
    printDepartmentForm(value) {
        ...
        form.appendChild(button);
        body.appendChild(div);
        __WEBPACK_IMPORTED_MODULE_0__validation__["a" /* default */].validationDepartmentFunction();
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DrawUtil__ = __webpack_require__(0);
...
__WEBPACK_IMPORTED_MODULE_0__DrawUtil__["a" /* default */].render(window.location.href);
...
class Validator {
    ...
    validationDepartmentFunction() {
        $("#department-form").validate({
            ...
            submitHandler: (form, event) => {
                ...
                __WEBPACK_IMPORTED_MODULE_0__DrawUtil__["a" /* default */].insertObject("/update_department", __WEBPACK_IMPORTED_MODULE_0__DrawUtil__["a" /* default */].toJsonString(form), 'department');
            }
    ...
    validationEmployeeFunction() {
        $("#employee-form").validate({
            ...
            submitHandler(form, event) {
                event.preventDefault();
                __WEBPACK_IMPORTED_MODULE_0__DrawUtil__["a" /* default */].insertObject("/update_employee", __WEBPACK_IMPORTED_MODULE_0__DrawUtil__["a" /* default */].toJsonString(form), 'employee');
            }
